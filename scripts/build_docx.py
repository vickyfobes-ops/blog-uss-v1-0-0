...
def core_properties_xml(title: str, language: str) -> bytes:
    ...
    ET.SubElement(root, q(DC, "creator")).text = "Blog—LCW—v1.0.0"
    ET.SubElement(root, q(CP, "lastModifiedBy")).text = "Blog—LCW—v1.0.0"
...
def app_properties_xml() -> bytes:
    ...
    ET.SubElement(root, q(EP, "Application")).text = "Blog—LCW—v1.0.0"
